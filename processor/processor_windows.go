...
var (
	...
	UpgradeMethodMap = map[int]string{
		1:  "Other",
		2:  "Unknown",
		3:  "Daughter Board",
		4:  "ZIF Socket",
...
func GetProcessorInformation() (*ProcessorInformation, error) {
	...
	info := &ProcessorInformation{
		...
		Voltage:           result.VoltageCaps,
		ExternalClock:     strconv.Itoa(result.ExtClock),
		MaxSpeed:          strconv.Itoa(result.MaxClockSpeed),
		CurrentSpeed:      strconv.Itoa(result.CurrentClockSpeed),
		Status:            result.Status,
		Upgrade:           UpgradeMethodMap[result.UpgradeMethod],
		SerialNumber:      result.SerialNumber,
		AssetTag:          result.AssetTag,
		CoreCount:         result.NumberOfCores,
		CoreEnabled:       result.NumberOfEnabledCore,
